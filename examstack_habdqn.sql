...
INSERT INTO `et_question` VALUES ('127', '通过客户的近期从浏览...', '{\"title\":\"通过客户的近期从浏览到购买的行为，客户的购买频率以及购买金额三项指标来描述该客户的价值，分别可以帮助我们衡量客户的哪些指标？\\u003cbr /\\u003e\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"流失度\",\"B\":\"活跃度\",\"C\":\"忠诚度\",\"D\":\"消费能力\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,C,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('128', 'SNS 的作用有哪些...', '{\"title\":\"SNS 的作用有哪些？\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"维护、拓展社会关系\",\"B\":\"形成数量庞大的个人社区\",\"C\":\"基于真实关系的现实应用\",\"D\":\"开展各种线上线下活动\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,C,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('129', '推广宝贝直通车标题跟...', '{\"title\":\"推广宝贝直通车标题跟店铺标题的关系说法错误的是？()\\u0026nbsp;\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"两个标题必须一模一样\",\"B\":\"两个标题可以不一样\",\"C\":\"两个标题都要求在 10 个字内\",\"D\":\"两个标题的描述一定要和商品相符合\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,C', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('130', '如果一家店铺昨日的流...', '{\"title\":\"如果一家店铺昨日的流量突降，他可以从量子里的哪里找原因？\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"来源分析中的访客分析\",\"B\":\"标准包中的来源构成报表\",\"C\":\"标准包中的流量概况报表\",\"D\":\"标准包的当前实时访问报表\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,C', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('131', '以下关于钻石展位定义...', '{\"title\":\"以下关于钻石展位定义的描述，正确的是\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"精选了淘宝和互联网优质展示位\",\"B\":\"按照竞价排序\",\"C\":\"按照点击计费\",\"D\":\"按照展现计费\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('132', '淘宝搜索页面，所有宝...', '{\"title\":\"淘宝搜索页面，所有宝贝搜索页下除了综合搜索以外，还有那些筛选搜索选项？\\u003cbr /\\u003e\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"人气\",\"B\":\"销量\",\"C\":\"厂家\",\"D\":\"价格\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('133', '聚划算商品展示时的短...', '{\"title\":\"聚划算商品展示时的短标题，要求是\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"标题必需要是品牌名+生产厂家名称的格式\",\"B\":\"在字数条件允许的前提下可适当添加营销文案，但一定要在规定内容之后显示\",\"C\":\"可以同时使用中英文品牌名\",\"D\":\"不得使用“专供”“特供”“最佳”等容易产生误导的字眼\"}}', '2', null, '0', null, '0', null, 'admin', null, 'B,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('134', '下列那些因素会促使免...', '{\"title\":\"下列那些因素会促使免费流量下降\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"标题关键词堆砌\",\"B\":\"放错属性\",\"C\":\"橱窗推荐\",\"D\":\"滥用品牌词\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('135', '淘宝客喜欢选择什么样...', '{\"title\":\"淘宝客喜欢选择什么样的宝贝进行推广\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"宝贝转化比较低\",\"B\":\"宝贝佣金比较低的\",\"C\":\"宝贝佣金高的，转化高的\",\"D\":\"宝贝 30 天淘宝客推广销售量多的\"}}', '2', null, '0', null, '0', null, 'admin', null, 'C,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('136', '小新是一家女装店的售...', '{\"title\":\"小新是一家女装店的售后客服,一个客户旺旺咨询他买的裤子是否已经发货。他在跟进回复客户时要注意的原则有\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"要快速\",\"B\":\"要热情\",\"C\":\"要有诚意\",\"D\":\"要跟售前客服确认\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,C,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('137', '细节图片的目的和作用', '{\"title\":\"细节图片的目的和作用\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"让买家进一步了解产品信息\",\"B\":\"展示产品不同的、必要的信息\",\"C\":\"说明产品的大小\",\"D\":\"展示产品的功能\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,C,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('138', '店铺为什么要做买家分...', '{\"title\":\"店铺为什么要做买家分析\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"可以更好了解买家特点\",\"B\":\"挖掘买家需求\",\"C\":\"提高广告投放精准度\",\"D\":\"帮助买家解决难题\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,C,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('139', '网店推广活动的效果一...', '{\"title\":\"网店推广活动的效果一般可以体现在哪些方面？\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"整个店铺的流量\",\"B\":\"在活动周期内给网店带来的客户数\",\"C\":\"实际成交额\",\"D\":\"获得了很多用户反馈的信息\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,C,D', '2', '1', '1', '1', '', '', '', '');
INSERT INTO `et_question` VALUES ('140', '参加直通车活动应该掌...', '{\"title\":\"参加直通车活动应该掌握的基本要求包括哪些？\",\"titleImg\":\"\",\"choiceList\":{\"A\":\"产品图片要求\",\"B\":\"产品推广的标题描述要求\",\"C\":\"店铺的要求,店铺信用评价和销售记录\",\"D\":\"公司实力和知名度需要达到一定的水平\"}}', '2', null, '0', null, '0', null, 'admin', null, 'A,B,C,', '2', '1', '1', '1', '', '', '', '');
